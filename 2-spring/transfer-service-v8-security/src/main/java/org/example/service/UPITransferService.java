...
public class UPITransferService implements TransferService {
    ...
    @Transactional(transactionManager = "transactionManager", isolation = Isolation.READ_COMMITTED, propagation = Propagation.REQUIRED, rollbackFor = {
            RuntimeException.class }, noRollbackFor = { AccountBalanceException.class })
